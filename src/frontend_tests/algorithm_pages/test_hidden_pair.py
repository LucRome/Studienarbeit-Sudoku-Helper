...
class TestHiddenPair(ut.TestCase):
    """
    the Tests for the Hidden Pair Algorithm Page
    """
    driver: WebDriver = None

    def setUp(self) -> None:
        self.driver = start_driver(get_page_sub_url('hidden_pair'))
